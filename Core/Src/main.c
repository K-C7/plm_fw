...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, RELAY_0_Pin|RELAY_1_Pin|LED_0_Pin|LED_1_Pin
                          |SEG_SER_Pin|SEG_RCLK_Pin|SEG_SRCLK_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LED_2_Pin|SEG_DIG_0_Pin|SEG_DIG_1_Pin|SEG_DIG_2_Pin
                          |SEG_DIG_3_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = RELAY_0_Pin|RELAY_1_Pin|LED_0_Pin|LED_1_Pin
                          |SEG_SER_Pin|SEG_RCLK_Pin|SEG_SRCLK_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : LED_2_Pin SEG_DIG_0_Pin SEG_DIG_1_Pin SEG_DIG_2_Pin
                           SEG_DIG_3_Pin */
  GPIO_InitStruct.Pin = LED_2_Pin|SEG_DIG_0_Pin|SEG_DIG_1_Pin|SEG_DIG_2_Pin
                          |SEG_DIG_3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
